...
func TestGetAllUser(t *testing.T) {
	...
	t.Run("Success Case", func(t *testing.T) {
		...
		mockRepo.On("GetAllUser").Return(mockUsers, nil).Once()
	...
	t.Run("Error Case - Repository Failure", func(t *testing.T) {
		...
		mockRepo.On("GetAllUser").Return(nil, errors.New("database error")).Once()

		// Call the method being tested.
		_, err := userService.GetAllUser()
	...
	t.Run("Error Case - Users Not Found", func(t *testing.T) {
		// Mock the repository to simulate "not found" error.
		mockRepo.On("GetAllUser").Return([]user.User{}, errors.New("not found")).Once()
...
func TestSearchUser(t *testing.T) {
	...
	t.Run("Success Case", func(t *testing.T) {
		...
		mockRepo.On("SearchUser", mockName).Return(mockUsers, nil).Once()

		// Call the method being tested.
		result, err := userService.SearchUser(mockName)
	...
	t.Run("Error Case - Repository Failure", func(t *testing.T) {
		// Mock the repository to simulate an error.
		mockName := "John"
		mockRepo.On("SearchUser", mockName).Return(nil, errors.New("database error")).Once()

		// Call the method being tested.
		_, err := userService.SearchUser(mockName)
