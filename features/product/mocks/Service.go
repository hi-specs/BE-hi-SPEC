...
func (_m *Service) CariProduct(name string, category string, minPrice uint, maxPrice uint, page int, limit int) ([]product.Product, error) {
...
func (_m *Service) SemuaProduct(page int, limit int) ([]product.Product, error) {
