...
func (_m *Repository) GetAllProduct(page int, limit int) ([]product.Product, int, error) {
...
func (_m *Repository) SearchProduct(name string, category string, minPrice uint, maxPrice uint, page int, limit int) ([]product.Product, int, error) {
